...
<body>
    <div class="navbar">
        ...
        <div class="nav-links">
            <form action="recipeuploading.jsp" method="get">
                <button type="submit">Upload Recipe</button>
            </form>
            <form action="youruploads" method="get">
                <button type="submit">Your Uploads</button>
            </form>
    ...
    <div class="welcome-section">
        <h1>Welcome, Cook<span id="username">${name}!!<br> Let's Cook new recipes</span>!</h1>
    </div>
</body>
</html>
